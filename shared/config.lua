...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vector4(-563.4076, -115.8488, 42.2543, 246.6314),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "mechanic",
        coords = vector4(-209.8713, -1331.8649, 23.1426, 23.5997),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
        ...
        ["Female"] = {
            {
                name = "Travail",
                outfitData = {
                    ["t-shirt"] = { item = 191, texture = 0 }, -- T-Shirt
                    ["mask"] = { item = 36, texture = 0 },     -- Mask
                },
                grades = { 1, 2, 3 },
            }
